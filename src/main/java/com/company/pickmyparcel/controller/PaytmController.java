...
import com.company.pickmyparcel.model.PaytmOrderResponse;
...
public class PaytmController {
    ...
    @ResponseBody
    public ResponseEntity<PaytmOrderResponse> processOrder(@RequestBody Deal deal, @PathParam("upiId") String upiId) throws Exception {
...
//            url = new URL("https://securegw-stage.paytm.in/theia/api/v1/processTransaction?mid=JBEzpy42288253468787&orderId=ORDERID_98928");
           ...
           /* System.out.print("\n**********************Enter any key**********************************************************************-");
            ...
            if ("TXN_SUCCESS".equals(transactionStatus)) {
                ...
                paytmOrderResponse.setOrderId(successOrderId);
                paytmOrderResponse.setBankTxnId(bankTxnId); // IMPORTANT : IN SUCCESS CASE WE ARE STORING bankTxnId and FAILURE CASE WE ARE STORING txnId.
                paytmOrderResponse.setTxnAmount(txnAmount2);
                paytmOrderResponse.setResultStatus(transactionStatus);
                Deal savedDeal = dealService.saveDealViaPaytm(deal, DealPaymentStatus.PAID);
                paytmOrderResponse.setDealId(savedDeal.getDealId());
                ...
                paytmOrderResponse.setOrderId(finalResponseBody.get("orderId").toString());
                paytmOrderResponse.setMessage(resultInfoJson.get("resultMsg").toString());
                paytmOrderResponse.setResultStatus(transactionStatus);
            ...
            PaytmOrderResponse errResponse = new PaytmOrderResponse();
        ...
        return ResponseEntity.ok(paytmOrderResponse);
    }
